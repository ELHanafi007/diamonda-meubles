...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "t1",
    name: "Tableau Abstrait Contemporain",
    price: "9.500",
    image: "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?q=80&w=1200",
    category: "Décoration",
    subCategory: "Tableaux",
    material: "Huile sur Toile",
    description: "Une œuvre d'art originale pour sublimer vos murs.",
    featured: true,
    inStock: true,
  },
  {
    id: "ttl1",
    name: "Tête de lit en Velours",
    price: "6.200",
    image: "https://images.unsplash.com/photo-1616594039964-ae9021a450a0?q=80&w=1200",
    category: "Espace de nuit",
    subCategory: "Têtes de lits",
    material: "Velours Capitonné",
    description: "Ajoutez une touche de majesté à votre chambre.",
    featured: true,
    inStock: true,
  },
  {
