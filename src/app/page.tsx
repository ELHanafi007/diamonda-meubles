...
export default function Home() {
  return (
    <>
      ...
      <section className="py-24 md:py-40 bg-[#FAF9F6] px-6 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            ...
            <div className="space-y-10 md:space-y-12">
              <motion.div
                ...
                className="space-y-4"
              >
                <span className="text-gold uppercase tracking-[0.4em] text-[10px] md:text-xs font-bold block">Notre Vision</span>
                <h2 className="text-4xl md:text-6xl lg:text-7xl font-serif leading-[1.1] tracking-tight text-primary">
                  L'Art de créer des espaces qui <span className="italic text-gold/80">racontent votre histoire</span>.
                </h2>
              </motion.div>
              ...
              <motion.div 
                ...
                className="pt-6"
              >
                <button className="group relative bg-black text-white px-12 py-6 uppercase tracking-[0.3em] text-[10px] font-bold overflow-hidden transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.2)]">
      ...
      <section className="relative py-32 md:py-48 bg-black text-white px-6 overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-7xl lg:text-8xl font-serif leading-none tracking-tighter">
              Prêt à sublimer <br />
              <span className="italic text-gold/80">votre intérieur ?</span>
            </h2>
            <p className="text-white/50 text-xs md:text-sm uppercase tracking-[0.4em] max-w-lg mx-auto leading-relaxed">
              Nos conseillers vous accompagnent dans la réalisation de vos projets les plus ambitieux.
            </p>
            <div className="pt-8">
              <button className="group relative border border-white/30 text-white px-16 py-7 uppercase tracking-[0.3em] text-[10px] font-bold overflow-hidden transition-all duration-700 hover:border-white">
