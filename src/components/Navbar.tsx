  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled 
          ? "bg-white/70 backdrop-blur-xl py-3 shadow-[0_2px_20px_-10px_rgba(0,0,0,0.1)]" 
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
              ...
              {navLinks.map((link, idx) => (
                ...
                >
                  <Link
                    href={link.href}
                    onClick={() => setMobileMenuOpen(false)}
                    className="text-3xl font-serif tracking-tight hover:text-gold transition-colors block"
                  >
                    {link.name}
                  </Link>
                </motion.div>
            ...
            <div className="mt-auto px-10 pb-16 space-y-8">
